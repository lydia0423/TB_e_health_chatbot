...
def related(x_text):
    if "name" in x_text:
        ...
        y_text = "where are the nearest hospitals?"
    elif "hospitals near me" in x_text:
        y_text = "where are the nearest hospitals?"
    elif "hospital near me" in x_text:
        y_text = "where are the nearest hospitals?"
    elif "hospital nearby" in x_text:
        y_text = "where are the nearest hospitals?"
    elif "hospitals nearby" in x_text:
        y_text = "where are the nearest hospitals?"
...
responses = {
   ...
   "why is my urine orange in colour?": [
       "It is a known side effect from taking Rifampicin.  It can be found in other bodily fluids such as saliva, tears, or sweat.  This is normal and the colour would fade away over time."
   ],
   ...
   "where can I go for a tb test?": [
       '''
       There are 2 approved hospitals where you can go for a TB test.
   ...
   "sabak area": [
       "Klinik Kesihatan Simpang Lima (Functioning)"
   ],
